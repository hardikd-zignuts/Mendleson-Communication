...
import Assets9 from "../assets/img/Asset 5 2.png";
import Assets10 from "../assets/img/Asset 8 3.png";
import Assets11 from "../assets/img/Assets 9 1.png";
  ...
  return (
    <>
      <div id="vector">
        ...
        <img className="assets9" src={Assets9} alt="Assets9" />
        <img className="assets10" src={Assets10} alt="Assets10" />
        <img className="assets11" src={Assets11} alt="Assets11" />
      </div>
    </>
  );
};
