      ...
      <footer className="footer">
        <div className="footer-head">
          <div className="footer-head-social">
            <div className="footer-head-social--title footer-primary-text">Social</div>
          ...
          <div className="footer-head-explore">
            <div className="footer-head-explore--title footer-primary-text">Explore</div>
          ...
          <div className="footer-head-contact">
            <div className="footer-head-contact--title footer-primary-text">Contact</div>
          ...
          <div className="footer-head-email">
            <div className="footer-head-email--title footer-primary-text">Email</div>
            <div className="footer-sub-text">mendlesoncommunication@email.com</div>
          </div>
        </div>
